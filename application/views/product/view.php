...
<div class="container">
   <div class="row" style="margin-top:20px;">
      <a style="margin-bottom: 0px;" class="btn btn-add btn-lg" href="<?=base_url();?>"><i class="fa fa-home"></i><?=label(" Home");?></a>
      ...
      <table id="Table" class="table table-striped table-bordered" cellspacing="0" width="100%">
          <thead>
              <tr>
                  ...
                  <th class="hidden-xs"><?=label("Availability");?></th>
                  <th><?=label("Price");?></th>
                  <th><?=label("Action");?></th>
              </tr>
          </thead>
          ...
          <tbody>
             ...
             <?php $item = Stock::find('first', array('conditions' => array('product_id = ?', $product->id))); if(!$item)
            {$item=0;}else{$item=$item->quantity;}?>
              <tr>
   ...
   $.ajax({
       ...
       success: function(data)
       {
          ...
          $.ajax({
              ...
              error: function (jqXHR, textStatus, errorThrown){alert("modify combo error");}
         });
          console.log(items);
          $("#add_item").autocomplete({
             source: '<?= site_url('productcontroller/suggest'); ?>',
