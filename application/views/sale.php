  <div class="container">
    <a style="margin-bottom: 0px;margin-top:15px" class="btn btn-add btn-lg" href="<?=base_url();?>"><i class="fa fa-home"></i><?=label(" Home");?></a>
<br><br>

<!-- <div class="row rangeStat" style="margin-top:50px;">
      <h3 class="col-sm-12"><?=label('Day wise Sales');?></h3>
      <div class="col-md-6">
          <div class="form-group">
              ...
              <div class="input-group margin-bottom-sm">
                  ...
                  <input class="form-control" id="CustomerRange" type="text" name="daterange" data-disable-touch-keyboard />
              </div>
          </div>
      </div>
      <div class="col-md-6">
    ...
    <div class="row rangeStat" style="margin-top:50px;">
          <h3 class="col-sm-12"><?=label('Inventory Status');?></h3>
          <div class="col-md-6">
              <div class="form-group">
                  <label><?=label('SelectRange');?></label>
                  <div class="input-group margin-bottom-sm">
                      <span class="input-group-addon RangePicker"><i class="fa fa-calendar fa-fw" aria-hidden="true"></i></span>
                      <input class="form-control" id="CustomerRange1" type="text" name="daterange" />
                  </div>
              </div>
          </div>
          <div class="col-md-6">
      ...
      <thead class="thead-inverse">
        <tr>
          ...
          <th><?=label('Sale Date');?></th>
          <th><?=label('Status');?></th>
          
            <?php if($this->user->role === "admin"){?> <th><?=label('Action');?></th><?php } ?>
        </tr>
      </thead>
      <tbody>
      </tbody>
...
<script>
      ...
      $(function() {
          ...
          $('#CustomerRange1').val('01/01/'+d+' - 12/31/'+d);
